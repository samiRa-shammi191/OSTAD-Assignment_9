            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container first">
                        <h2>Hi there I'm Samira,</h2>
                        <p>And I love to create beautiful dynamic and efficient websites for my customers. I love going through the entire process with the customer from concept, to design and then development and launch</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p> <strong>Project:</strong> web design for their corporate websites and landing pages for marketing campaigns</p>
                    </div> <!-- end of text-container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">For any type of online project please don't hesitate to get in touch with me. The fastest way is to send me your message using the following email <a class="blue no-line" href="#your-link">samirashammi67@gmail.com</a></p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
